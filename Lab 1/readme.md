...
**FYI Using VMware Fusion Player**: VMware may not work support SEED Ubuntu 20.04 VM on Apple Silicon machines (M chips). Then you need to do the following steps.  
